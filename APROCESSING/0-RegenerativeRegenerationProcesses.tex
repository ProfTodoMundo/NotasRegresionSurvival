...
\begin{abstract}
En este documento, presentamos una revisión exhaustiva de los procesos de renovación y regenerativos, enfocándonos tanto en los fundamentos teóricos como en sus implicaciones prácticas. El estudio comienza con una introducción a los procesos estocásticos, específicamente las cadenas de Markov, las cadenas de Markov ergódicas, las cadenas homogéneas y las irreducibles. Se discuten conceptos clave como el cilindro, los conjuntos de Borel y medibles, la Delta de Kronecker, las ecuaciones de Chapman-Kolmogorov y las matrices de transición. Basándonos en esta base, exploramos los procesos regenerativos estacionarios, el teorema principal de renovación, la identidad de Wald para renovaciones, y las propiedades de los procesos de renovación, incluida la función de renovación. La sección final profundiza en la teoría de los procesos regenerativos, examinando tanto los procesos regenerativos estacionarios como los procesos de salida asociados con los procesos regenerativos, incluyendo el proceso Poisson y el teorema de existencia de los tiempos de regeneración. Esta revisión tiene como objetivo proporcionar una comprensión completa de estos procesos, que son cruciales en diversas áreas como la teoría de colas, la teoría de la fiabilidad y la investigación operativa.
\end{abstract}
...
Los procesos estoc\'asticos son fundamentales en la modelaci\'on de sistemas que evolucionan aleatoriamente con el tiempo. Entre estos, los procesos de renovación y los procesos regenerativos ocupan un lugar destacado debido a sus aplicaciones en diversas áreas como la teoría de colas, la teoría de la fiabilidad y la investigación operativa.

En este documento, se presenta una revisión detallada de los procesos de renovación y regenerativos. Comenzamos con una introducción a los procesos estocásticos, específicamente las cadenas de Markov, incluyendo las cadenas de Markov ergódicas y homogéneas, así como las cadenas irreducibles. Se discuten conceptos esenciales como las clases de comunicación, los estados absorbentes, recurrentes y transitorios, y la propiedad fuerte de Markov. También se abordan las ecuaciones de Chapman-Kolmogorov y las matrices de transición, fundamentales en la teoría de los procesos de Markov.

A partir de esta base, exploramos los procesos regenerativos estacionarios, el teorema principal de renovación, y las propiedades de los procesos de renovación, incluida la función de renovación y la ley fuerte de los grandes números para procesos de renovación. Además, se examina la ecuación de renovación y la identidad de Wald para renovaciones, conceptos clave en la teoría de la renovación.

La sección final profundiza en la teoría de los procesos regenerativos, examinando tanto los procesos regenerativos estacionarios como los procesos de salida asociados con los procesos regenerativos. Se discuten los procesos Poisson, los procesos wide-sense regenerative, los tiempos de inter-regeneración y los tiempos de regeneración. También se abordan conceptos avanzados como los mapeos medibles del retraso, los mapeos shift y los procesos shift-medibles.

Esta revisión tiene como objetivo proporcionar una comprensión exhaustiva de estos procesos, que son cruciales en diversas aplicaciones prácticas, incluyendo la teoría de colas, la teoría de la fiabilidad y la investigación operativa.
...
Sea $\left(X,\mathcal{G},\prob\right)$ espacio de probabilidad, $I\subset\rea$ conjunto de \'indices. Sea $\mathcal{F}_{\leq t}$ la $\sigma$-\'algebra natural definida como $\sigma\left\{f\left(X_{r}\right):r\in I, r\leq t,f\in\mathcal{E}\right\}$. Se considerar\'a una $\sigma$-\'algebra m\'as general\footnote{qu\'e se quiere decir con el t\'ermino: m\'as general?}, $ \left(\mathcal{G}_{t}\right)$ tal que $\left(X_{t}\right)$ sea $\mathcal{E}$-adaptado.
...
\begin{Coro}[Ley Fuerte de los Grandes N\'umeros para Procesos de Renovaci\'on]\index{Ley Fuerte de los Grandes N\'umeros para Procesos de Renovaci\'on}
...
\begin{Coro}[Identidad de Wald para Renovaciones]\index{Identidad de Wald para Renovaciones}
...
\begin{Coro}\label{Tma.Estacionariedad}\index{Teorema de Estacionariedad}
